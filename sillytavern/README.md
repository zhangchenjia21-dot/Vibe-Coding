...
- `G8网页产品化启动规划_v1.8_2026-08-18.md`：当前 G8 产品化规划。
- `G8阶段收口与G9前置裁定_v1.8_2026-08-18.md`：当前 G8→G9 阶段边界。
- `G8_StageUAT_语义物化与活世界阻塞发现_v1.0_2026-08-18.md`：当前 Stage UAT finding。
- `G8-UAT-02_GameLocalSemanticMaterialization与活世界收口规格_v1.0_2026-08-18.md`：当前实现任务基线。
...
Current Next        G8-UAT-02 implementation
G9                  NOT AUTHORIZED
```
